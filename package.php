...
<div class="jumbotron jumbotron-fluid package-details">
  <div class="container">
    <h1 class="display-4 text-primary font-weight-bold">Package Details</h1>
...
<div class="container">
    <div class="ml-auto p-2 mb-5">
        ...
        <h5 class="font-italic text-info" style="font-size: 1rem;"><i class="fas fa-map-marker-alt"></i><?php echo $package['location']; ?>, <?php echo $package['district']; ?></h5>
...
<div class="lead container tour-details-content">
    ...
    <div class="mt-5">
        <p>Starting from
            <h5>Le <?php echo $package['budget_price']; ?>  per person</h5>
        </p>
        <?php
...
<!-- Itinerary -->
<div class=" lead container itinerary-content">
...
<!-- gallery -->
<div class="lead container gallery-content">
