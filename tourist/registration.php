<?php
    ...
    if(isset($_POST['tourist_register'])){
        ...
        if(!empty($tourist_emails)){
            ...
            $stmt = $pdo->prepare('INSERT INTO tourists( tourist_username, tourist_firstname, tourist_lastname, tourist_email,
             tourist_password, profile_image, tourist_contact, tourist_address, tourist_status, date) VALUES( :tourist_username, :tourist_firstname, :tourist_lastname, :tourist_email, :tourist_password, :profile_image, :tourist_contact, :tourist_address, :tourist_status, :date)');
    ...
    //':tourist_stripe'      => $customer->id,

?>

<br><br><br>
<div class="container mb-5">
    <h2 class="text-secondary text-center p-2 pb-4">Tourist Register Here</h2><br>
    ...
    ?>
        ...
        <div class="form-group p-2">
            ...
            <input type="text" class="form-control" id="" pattern="^[A-Za-z]+$" name="tourist_username" required>
        </div>
        <div class="form-group p-2">
            <label for="tourist_firstname">First Name *</label>
            <input type="text" class="form-control" id="" pattern="^[A-Za-z]+$" name="tourist_firstname" required>
        </div>
        <div class="form-group p-2">
            <label for="tourist_lastname">Last Name *</label>
            <input type="text" class="form-control" id="" pattern="^[A-Za-z]+$" name="tourist_lastname" required>
        </div>
        <div class="form-group p-2">
        ...
        <div class="form-group p-2">
            ...
            <input type="file" id="" name="profile_image" required>
        </div>
        <div class="form-group p-2">
