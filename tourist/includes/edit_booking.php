        ...
        if(isset($_GET['edit'])){
            if(isset($_POST['update_book'])){
                ...
                if($travel_style == '' || $persons == ''){
                    ...
                    $stmt = $pdo->prepare('UPDATE bookings SET package_id = :package_id, tourist_id = :tourist_id, agency_id = :agency_id, persons = :persons, travel_style = :travel_style, enquiry_msg = :enquiry_msg, booking_status = :booking_status, date = :date WHERE booking_id = :booking_id');
