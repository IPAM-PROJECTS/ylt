...
<head>
    ...
    <style>
        .agency {
  background-image: url("./images/ <?php echo $agency['logo_image']; ?>");
...
<div class="lead container package-content">
    ...
    <div class="container ml-5">
        <form action="search_agency_package.php?agency_id=<?php echo $agency_id; ?>" method="post" class="input-group ml-3 mt-5 float-center">
            <input type="text" name="search" id="" placeholder="Search Agencies or package" class="form-control col-md-4" style="border-top-right-radius: 3px;  border-bottom-right-radius: 3px;"> 
