  ...
  <div class="container">
    ...
    <p class="lead">
        <form action="search.php" method="post" class="input-group">
            <input type="text" name="search" id="" placeholder="Search for Agencies or Packages" class="form-control col-md-4" style="border-top-right-radius: 3px;  border-bottom-right-radius: 3px;">
            <button class="btn btn-outline-primary ml-2 p-2" style="color:blue;" type="submit" name="submit"><i class="fas fa-search"></i></button>
        </form>
    </p>
  </div>
</div>
