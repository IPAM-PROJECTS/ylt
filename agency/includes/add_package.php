<?php
    ...
    if(isset($_SESSION['agency_id'])){
        if(isset($_POST['create_package'])){
            ...
            if($package_name == '' || $location == '' || $district == '' || $budget_price == '' || $booking_percentage == ''){
                $_SESSION['error'] = 'Please Fill the Form';
                header('Location: packages.php?page=add_package');
                return;
            }else{
                $stmt = $pdo->prepare('INSERT INTO packages(agency_id, package_name, location, district, place_details, place_images, num_days, num_nights, budget_price, comfort_price, lux_price, budget_details, comfort_details, lux_details, booking_percentage, min_people, includes, excludes, optional, itinerary, package_status, package_date) VALUES(:agency_id, :package_name, :location, :district, :place_details, :place_images, :num_days, :num_nights,  :budget_price, :comfort_price, :lux_price, :budget_details, :comfort_details, :lux_details, :booking_percentage, :min_people, :includes, :excludes, :optional, :itinerary, :package_status, :package_date)');
...
<div class="container">
    ...
    <form action="" method="post" enctype="multipart/form-data" class="col-md-8">
        <div class="form-group p-2">
            ...
            <input type="text" class="form-control" id="" name="package_name" required>
        </div>
        <div class="form-group p-2">
    ...
    <select class="form-control" id="district" name="district" required>
        ...
        <option value="western_urban">Western Urban</option>
        <option value="western_rural">Western Rural</option>
        ...
        <option value="port_loko">Port Loko</option>
        <option value="bo">Bo</option>
        <option value="bonthe">Bonthe</option>
        <option value="moyamba">Moyamba</option>
        <option value="pujehun">Pujehun</option>
        <!-- Add more options for other districts in Sierra Leone -->
    </select>
</div>

        <div class="form-group p-2">
            <label for="place_details">Place Details *</label>
            <textarea name="place_details" class="form-control" id="body" cols="30" rows="5" required></textarea>
        </div>
        <div class="form-group p-2">
            <label for="">Place Images *</label><br>
            <input type="file" name="place_images[]" multiple required>
        </div>
        <div class="form-group p-2">
            <label for="num_days">Number of days *</label>
            <input type="number" class="form-control" id="" name="num_days" required>
        </div>
        <div class="form-group p-2">
            <label for="num_nights">Number of nights *</label>
            <input type="number" class="form-control" id="" name="num_nights" required>
        </div>
        <div class="form-group p-2">
            ...
            <input type="text" class="form-control" id="" name="lux_details" placeholder="Luxury" required>
        </div>
        <div class="form-group p-2">
        ...
        <div class="form-group p-2">
            <label for="booking_percentage">Booking Price(%) required *</label>
            <input type="number" class="form-control" id="" name="booking_percentage" required>
        </div>
        <div class="form-group p-2">
            <label for="min_people">Minimum People required to start *</label>
            <input type="number" class="form-control" id="" name="min_people" required>
        </div>
        <div class="form-group p-2">
        ...
        <div class="form-group p-2">
            ...
            <textarea name="excludes" class="form-control" id="body" cols="30" rows="5" required></textarea>
        </div>
        <div class="form-group p-2">
        ...
        <div class="form-group p-2">
            ...
            <textarea name="itinerary" class="form-control" id="body" cols="30" rows="10" required></textarea>
        </div>
        <div class="form-group p-2">
