...
<div class="container-fluid">
    ...
    <form action="" method="post" enctype="multipart/form-data" class="col-md-8">
        <div class="form-group p-2">
            ...
            <input type="text" class="form-control" value="<?php echo $agency['owner_firstname']; ?>" id="" name="owner_firstname" requied>
        </div>
        <div class="form-group p-2">
            <label for="owner_lastname">Owner's Last Name *</label>
            <input type="text" class="form-control" requied value="<?php echo $agency['owner_lastname']; ?>" id="" name="owner_lastname" requied>
        </div>
        <div class="form-group p-2">
            <label for="agency_password">Password *</label>
            <input type="password" class="form-control" value="" id="" name="agency_password" requied>
        </div>
        <div class="form-group p-2">
            <label for="logo_image">Logo *</label><br>
            <img src="../images/<?php echo $agency['logo_image']; ?>" requied width="150" height='120' alt="<?php echo $agency['agency_name']; ?>" ><br><br>
            <input type="file" id="" name="logo_image">
        </div>
        <div class="form-group p-2">
            <label for="cover_image">Cover Photo *</label><br>
            <img src="../images/<?php echo $agency['cover_image']; ?>" requied width="150" height='120' alt="<?php echo $agency['agency_name']; ?>" ><br><br>
            <input type="file" id="" name="cover_image">
        </div>
        <div class="form-group p-2">
            <label for="agency_contact">Contact Number *</label>
            <input type="text" class="form-control" value="<?php echo $agency['agency_contact']; ?>" id="" name="agency_contact" requied>
        </div>
        <div class="form-group p-2">
            <label for="agency_address">Office Address *</label>
            <input type="text" class="form-control" value="<?php echo $agency['agency_address']; ?>" id="" name="agency_address" required>
        </div>
        <div class="form-group p-2">
