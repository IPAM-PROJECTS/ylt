...
<div class="container">
    ...
    <form action="" method="post" enctype="multipart/form-data" class="col-md-8">
        <div class="form-group pb-2">
            ...
            <input type="text" class="form-control" value="<?php echo $package['package_name']; ?>" id="" name="package_name" required>
        </div>
        <div class="form-group p-2">
            <label for="location">Location *</label>
            <input type="text" class="form-control" value="<?php echo $package['location']; ?>"  id="" name="location" required>
        </div>
        <div class="form-group p-2">
            <label for="district">District *</label>
           
    <select class="form-control" id="district" name="district">
        <option value=""><?php echo $package['district']; ?></option>
        ...
        <div class="form-group p-2">
            ...
            <textarea name="includes" class="form-control" id="body" cols="30" rows="5" required><?php echo $package['includes']; ?></textarea>
        </div>
        <div class="form-group p-2">
