...
<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #04234D;">
        <div class="sb-sidenav-menu">
            <div class="nav pt-3">
            <!-- <img src="../images/ylt.png" alt="logo" style="width: 100px; height: 100px; margin-left: 35px; margin-top: -70px"> 
            <h5><span class="gradient-text">YEAMA LEONE TOURS</span></h5> -->

            <center>
            <!-- <img src="../images/<?php //echo $agency['logo_image']; ?>" alt="logo" style="width: 100px; height: 100px;  margin-top: -70px">  -->
            <!-- <img src="<?php //echo $imageSrc; ?>" alt="logo" style="width: 100px; height: 100px; margin-top: -70px"> -->
            <h5><span class="gradient-text "><?php echo $_SESSION['agency_name']; ?></span></h5>
                </center>
                <a class="nav-link" href="index.php">
                    Dashboard
                </a>
                <?php
                    if( $_SESSION['agency_login'] == 'AgencyOwner' || $_SESSION['role'] !== 'Junior Staff'){
                ?>
