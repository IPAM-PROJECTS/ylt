<?php
    ...
    if(isset($_POST['agency_register'])){
        ...
        if(!empty($agency_emails)){
            ...
            $_SESSION['success'] = 'Your Registration has been submitted to Admin click the cancel button to go back';
            header('Location: register.php');
            return;
        }
    }
...
<br><br>
<div class="container">
    <h2 class="text-secondary text-center p-2 pb-4">Agency Register Here</h2><br>
    <form action="" method="post" class="mx-auto col-md-8">
        ...
        <div class="form-group p-2">
            ...
            <input type="text" class="form-control" pattern="^[A-Za-z]+$" id="" name="owner_firstname" required>
        </div>
        <div class="form-group p-2">
            <label for="owner_lastname">Owner's Last Name *</label>
            <input type="text" class="form-control" id="" pattern="^[A-Za-z]+$" name="owner_lastname" required>
        </div>
        <div class="form-group p-2">
