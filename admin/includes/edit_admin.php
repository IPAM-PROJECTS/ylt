...
<div class="container" >
    ...
    <form action="" method="post" class="col-md-8">
        <div class="form-group pb-2">
            ...
            <input type="text" class="form-control" value="<?php echo $admin['username']; ?>" id="" name="username" required>
        </div>
        <div class="form-group p-2">
            <label for="firstname">First Name *</label>
            <input type="text" class="form-control" value="<?php echo $admin['admin_firstname']; ?>" id="" name="admin_firstname" required>
        </div>
        <div class="form-group p-2">
            <label for="lastname">Last Name *</label>
            <input type="text" class="form-control" id="" value="<?php echo $admin['admin_lastname']; ?>" name="admin_lastname" required>
        </div>
        <div class="form-group p-2">
            <label for="email">Email address *</label>
            <input type="email" class="form-control" value="<?php echo $admin['admin_email']; ?>" id="" name="admin_email" required>
        </div>
        <div class="form-group p-2">
            <label for="password">Password *</label>
            <input type="password" class="form-control" id="" name="admin_password" required>
        </div>
        <div class="form-group p-2">
