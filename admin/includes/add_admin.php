<?php
    ...
    if(isset($_POST['create_admin'])){
        ...
        if(!empty($email_validate)){
            ...
            $stmt = $pdo->prepare('INSERT INTO admins(username, admin_firstname, admin_lastname, admin_email, admin_password, date) VALUES(:username, :admin_firstname, :admin_lastname, :admin_email, :admin_password, :date)');
...
<div class="container" >
    ...
    <form action="" method="post" enctype="multipart/form-data" class="col-md-8">
        ...
        <div class="form-group p-2">
            ...
            <input type="text" class="form-control" id="" name="admin_firstname" required>
        </div>
        <div class="form-group p-2">
            <label for="lastname">Last Name *</label>
            <input type="text" class="form-control" id="" name="admin_lastname" required>
        </div>
        <div class="form-group p-2">
            <label for="email">Email address *</label>
            <input type="email" class="form-control" id="" name="admin_email" required>
        </div>
        <div class="form-group p-2">
