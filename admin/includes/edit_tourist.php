...
<div class="container" >
    ...
    <form action="" method="post" enctype="multipart/form-data" class="col-md-8">
        <div class="form-group pb-2">
            ...
            <input type="text" class="form-control" value="<?php echo $tourist['tourist_username']; ?>" id="" name="tourist_username"  required>
        </div>
        <div class="form-group p-2">
            <label for="tourist_firstname">First Name *</label>
            <input type="text" class="form-control" value="<?php echo $tourist['tourist_firstname']; ?>" id="" name="tourist_firstname" required>
        </div>
        <div class="form-group p-2">
            <label for="tourist_lastname">Last Name *</label>
            <input type="text" class="form-control" id="" value="<?php echo $tourist['tourist_lastname']; ?>" name="tourist_lastname" required>
        </div>
        <div class="form-group p-2">
            <label for="tourist_email">Email address *</label>
            <input type="email" class="form-control" value="<?php echo $tourist['tourist_email']; ?>" id="" name="tourist_email" required>
        </div>
        <div class="form-group p-2">
            <label for="tourist_password">Password *</label>
            <input type="password" class="form-control" value="" id="" name="tourist_password" required>
        </div>
        <div class="form-group p-2">
            <label for="profile_image">Profile Picture *</label><br>
            <img src="../images/<?php echo $tourist['profile_image']; ?>" width="150" height='120' alt="<?php echo $tourist['tourist_username']; ?>"  required><br><br>
            <input type="file" id="" name="profile_image">
        </div>
        <div class="form-group p-2">
            <label for="tourist_contact">Contact Number *</label>
            <input type="text" class="form-control" value="<?php echo $tourist['tourist_contact']; ?>" id="" name="user_contact" required>
        </div>
        <div class="form-group p-2">
            <label for="user_address">Address *</label>
            <input type="text" class="form-control" value="<?php echo $tourist['tourist_address']; ?>" id="" name="tourist_address" required>
        </div>
        <div class="form-group p-2">
