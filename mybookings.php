    ...
    <table class="table table-bordered table-hover mt-5" style="background: #F6F4F6;">
        <thead>
            <tr>
                ...
                <th>Booking Date</th>
                <th>Total Price</th>
                <th>Booking First Installement</th>
                <!-- <th>My Status</th> -->
        ...
        <?php
            ...
            foreach($bookings as $booking){
                ...
                if(!empty($book) && $book['booking_status'] == 'travelling'){
                    echo '<tr class="table table-info">';
                }elseif(!empty($book) && $book['booking_status'] == 'completed'){
                    ...
                    //     echo '<td><a href="#" class="btn btn-primary">Confirm</a></td>';
                    // }else
                    // if($booking['booking_status'] == 'confirm' ){
                    ...
                    // }else {
                    //     echo '<td><a href="#" class="btn btn-primary disabled">Confirmed</a></td>';
                    // }
                    ...
                    if(empty($date)){
                        ...
                        if($date['status'] == 'extended'){
                            ...
                            echo '<td class="text-success font-weight-bold">We are ready </td>';
                        }else{
                    ...
                    if($booking['booking_status'] == 'pending' || $booking['booking_status'] == 'reject' || $booking['booking_status'] == 'confirm' || (!empty($date) && $date['status'] == 'extended')){
